...
static const TString datadir=gSystem->Getenv("HEATESDATADIR");
static const TString rootdir=datadir+"/dumproot";
...
//static const TString fhe3_on=Form("%s/%s/output/hpht_phc_on_run0160_0301_pre000_post500.root",anadir.Data(),makechhist_dir.Data());
//static const TString fhe4_on=Form("%s/%s/output/hpht_phc_on_run0320_0424_pre000_post500.root",anadir.Data(),makechhist_dir.Data());
...
inline string getFileName(string filePath, bool withExtension=true, char seperator='/')
{
...
inline TString backup_rootfile(TString fname)
{
