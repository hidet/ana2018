...
f.chanall.Draw("sec_pr_mean>>h_sec_prm_spilloff","good==1 && primary==1 && beam==0","GOFF")
f.chanall.Draw("sec_pr_mean>>h_sec_prm_spillon","good==1 && primary==1 && beam==1","GOFF")
...
h_sec_prm_spilloff.SetTitle(fname+" secondary peak region mean spill off/on")
...
ROOT.gPad.SetLogy()
legend.Draw("same")
c1.SaveAs(outdir+fname+"_sec_pr_mean.pdf")
...
for i in xrange(len(sec_prm_cuts)):
    f.chanall.Draw("energy_phc>>h_ene_phc%d"%(i),"good==1 && primary==1 && %s"%(sec_prm_cuts[i]),"GOFF")
    h_ene_phc[i].SetLineColor(i+1)
    if i==0:
        legend.AddEntry(h_ene_phc[i], "spill off, no cut", "l")
        h_ene_phc[i].SetTitle(fname+" energy_phc with sec_prm cuts")
        ...
        h_ene_phc[i].DrawCopy("histsame")
legend.Draw("same")
c2.SaveAs(outdir+fname+"_energy_phc_sec_prm_cuts.pdf")


c3 = ROOT.TCanvas("c3","c3")
h_ene_phc[0].SetTitle(fname+" energy_phc with sec_prm cuts (normalized)")
...
legend.Draw("same")
c3.SaveAs(outdir+fname+"_energy_phc_sec_prm_cuts_norm.pdf")
...
f.chanall.Draw("energy_phc>>h_ene_phc_g","good==1 && primary==1 && beam==1 && sec_pr_mean>-10 && sec_pr_mean<=10","GOFF")
f.chanall.Draw("energy_phc>>h_ene_phc_b","good==1 && primary==1 && beam==1 && !(sec_pr_mean>-10 && sec_pr_mean<=10)","GOFF")
...
h_ene_phc_g.SetTitle(fname+" energy_phc with sec_prm cuts")
...
legend2.Draw("same")
c4.SaveAs(outdir+fname+"_energy_phc_sec_prm_cuts_goodbad.pdf")



h_ene_vs_prm = ROOT.TH2F("h_ene_vs_prm","h_ene_vs_prm",1000,5000,10000,30,-50,70)
c5 = ROOT.TCanvas("c5","c5")
f.chanall.Draw("sec_pr_mean:energy_phc>>h_ene_vs_prm","good==1 && primary==1 && beam==1","GOFF")
h_ene_vs_prm.SetTitle(fname+" energy_phc vs sec_prm spill on")
h_ene_vs_prm.GetXaxis().SetTitle("Energy [eV]")
h_ene_vs_prm.GetYaxis().SetTitle("sec_pr_sum [ch]")
h_ene_vs_prm.DrawCopy("cont4")
ROOT.gPad.SetLogz()
c5.SaveAs(outdir+fname+"_energy_phc_vs_sec_prm.png")
...
legend.SetFillColor(0)
legend.SetTextSize(0.03)
f.chanall.Draw("jbr_region_sum>>h_jbr_spilloff","good==1 && primary==1 && beam==0","GOFF")
f.chanall.Draw("jbr_region_sum>>h_jbr_spillon","good==1 && primary==1 && beam==1","GOFF")
legend.AddEntry(h_jbr_spilloff, "spill off", "l")
legend.AddEntry(h_jbr_spillon, "spill on", "l")
h_jbr_spillon.SetLineColor(2)
h_jbr_spilloff.SetTitle(fname+" just before rising region sum spill off/on")
...
ROOT.gPad.SetLogy()
legend.Draw("same")
c6.SaveAs(outdir+fname+"_jbr_sum.pdf")
...
jbr_cuts=["beam==0 && jbr_region_sum!=-1e6",
          ...
          "beam==1 && jbr_region_sum>=0 && jbr_region_sum<200",
          "beam==1 && jbr_region_sum>=200 && jbr_region_sum<400",
          "beam==1 && jbr_region_sum>=400"]
...
for i in xrange(len(jbr_cuts)):
    f.chanall.Draw("energy_phc>>h_ene_phc_jbr%d"%(i),"good==1 && primary==1 && %s"%(jbr_cuts[i]),"GOFF")
    h_ene_phc_jbr[i].SetLineColor(i+1)
    if i==0:
        legend.AddEntry(h_ene_phc_jbr[i], "spill off, no cut", "l")
        h_ene_phc_jbr[i].SetTitle(fname+" energy_phc with jbr cuts")
        ...
        h_ene_phc_jbr[i].DrawCopy("histsame")
legend.Draw("same")
c7.SaveAs(outdir+fname+"_energy_phc_jbr_cuts.pdf")


c8 = ROOT.TCanvas("c8","c8")
h_ene_phc_jbr[0].SetTitle(fname+" energy_phc with jbr cuts (normalized)")
...
legend.Draw("same")
c8.SaveAs(outdir+fname+"_energy_phc_jbr_cuts_norm.pdf")
...
legend2.SetFillColor(0)
legend2.SetTextSize(0.02)
f.chanall.Draw("energy_phc>>h_ene_phc_jbr_g","good==1 && primary==1 && beam==1 && jbr_region_sum>-400 && jbr_region_sum<=400","GOFF")
f.chanall.Draw("energy_phc>>h_ene_phc_jbr_b","good==1 && primary==1 && beam==1 && !(jbr_region_sum>-400 && jbr_region_sum<=400)","GOFF")
h_ene_phc_jbr_g.SetLineColor(2)
legend2.AddEntry(h_ene_phc_jbr_g, "jbr_region_sum>-400 && jbr_region_sum<=400", "l")
legend2.AddEntry(h_ene_phc_jbr_b, "other", "l")
h_ene_phc_jbr_g.SetTitle(fname+" energy_phc with jbr cuts")
...
legend2.Draw("same")
c9.SaveAs(outdir+fname+"_energy_phc_jbr_cuts_goodbad.pdf")



h_ene_vs_jbr = ROOT.TH2F("h_ene_vs_jbr","h_ene_vs_jbr",1000,5000,10000,400,-2000,2000)
c10 = ROOT.TCanvas("c10","c10")
f.chanall.Draw("jbr_region_sum:energy_phc>>h_ene_vs_jbr","good==1 && primary==1 && beam==1","GOFF")
h_ene_vs_jbr.SetTitle(fname+" energy_phc vs jbr spill on")
h_ene_vs_jbr.GetXaxis().SetTitle("Energy [eV]")
h_ene_vs_jbr.GetYaxis().SetTitle("jbr_region_sum [ch]")
h_ene_vs_jbr.DrawCopy("cont4")
ROOT.gPad.SetLogz()
c10.SaveAs(outdir+fname+"_energy_phc_vs_jbr.png")
...
legend2.SetFillColor(0)
legend2.SetTextSize(0.02)
f.chanall.Draw("energy_phc>>h_ene_phc_g","good==1 && primary==1 && beam==1 && sec_pr_mean>-10 && sec_pr_mean<=10 && jbr_region_sum<400","GOFF")
f.chanall.Draw("energy_phc>>h_ene_phc_b","good==1 && primary==1 && beam==1 && !(sec_pr_mean>-10 && sec_pr_mean<=10) && jbr_region_sum<400","GOFF")
h_ene_phc_g.SetLineColor(2)
legend2.AddEntry(h_ene_phc_g, "sec_pr_mean>-10 && sec_pr_mean<=10 && jbr_region_sum<400", "l")
legend2.AddEntry(h_ene_phc_b, "other && jbr_region_sum<400", "l")
h_ene_phc_g.SetTitle(fname+" energy_phc with sec_prm and jbr_resion_sum cuts")
h_ene_phc_g.GetXaxis().SetTitle("Energy [eV]")
h_ene_phc_g.GetYaxis().SetTitle("Counts / eV")
h_ene_phc_g.DrawCopy("hist")
h_ene_phc_b.DrawCopy("histsame")
legend2.Draw("same")
c11.SaveAs(outdir+fname+"_energy_phc_sec_prm_jbr_cuts_goodbad.pdf")
...
ROOT.gPad.SetLogy()
legend.Draw("same")
c12.SaveAs(outdir+fname+"_pre_sum.pdf")
...
for i in xrange(len(pre_cuts)):
    f.chanall.Draw("energy_phc>>h_ene_phc_pre%d"%(i),"good==1 && primary==1 && %s"%(pre_cuts[i]),"GOFF")
    h_ene_phc_pre[i].SetLineColor(i+1)
    if i==0:
        legend.AddEntry(h_ene_phc_pre[i], "spill off, no cut", "l")
        h_ene_phc_pre[i].SetTitle(fname+" energy_phc with pre cuts")
        ...
        h_ene_phc_pre[i].DrawCopy("histsame")
legend.Draw("same")
c13.SaveAs(outdir+fname+"_energy_phc_pre_cuts.pdf")


c14 = ROOT.TCanvas("c14","c14")
h_ene_phc_pre[0].SetTitle(fname+" energy_phc with pre cuts (normalized)")
...
legend.Draw("same")
c14.SaveAs(outdir+fname+"_energy_phc_pre_cuts_norm.pdf")
...
legend2.SetFillColor(0)
legend2.SetTextSize(0.02)
f.chanall.Draw("energy_phc>>h_ene_phc_preg","good==1 && primary==1 && beam==1 && pre_region_sum>-350","GOFF")
f.chanall.Draw("energy_phc>>h_ene_phc_preb","good==1 && primary==1 && beam==1 && !(pre_region_sum>-350)","GOFF")
h_ene_phc_preg.SetLineColor(2)
legend2.AddEntry(h_ene_phc_preg, "pre_region_sum>-350", "l")
legend2.AddEntry(h_ene_phc_preb, "other", "l")
h_ene_phc_preg.SetTitle(fname+" energy_phc with pre cuts")
...
legend2.Draw("same")
c15.SaveAs(outdir+fname+"_energy_phc_pre_cuts_goodbad.pdf")
...
ROOT.gPad.SetLogz()
c16.SaveAs(outdir+fname+"_energy_phc_vs_pre.png")
